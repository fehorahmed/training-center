                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                            action="{{ route('leader.store') }}" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Input group-->
                            <div class="row mb-6">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid"
                                            value="{{ old('short_designation') }}" placeholder="Enter Short Designation"
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <textarea name="short_description" class="form-control form-control-solid" id="short_description"
                                            placeholder="Enter Short Description" cols="30" rows="2">{{ old('short_description') }}</textarea>
