                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                            action="{{ route('batch.store') }}" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Input group-->
                            <div class="row mb-6">
                                <div class="col-md-6">
                                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                            value="{{ old('name') }}" placeholder="Enter Batch Name" name="name">
                                        @error('name')
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                ...
                                <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Store
                                    Batch</button>
                            </div>
                        </form>
                    </div>
