            ...
            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ in_array(Route::currentRouteName(), $menus) ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ in_array(Route::currentRouteName(), $menus) ? 'active' : '' }}"
                        ...
                        <span class="menu-title">Contact Message List</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ in_array(Route::currentRouteName(), $menus) ? 'active' : '' }}"
                        ...
                        <span class="menu-title">Global Configuration</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
