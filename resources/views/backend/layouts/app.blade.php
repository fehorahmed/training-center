                                        ...
                                        <div class="mh-300px scroll-y me-n7 pe-7">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{asset('assets/backend/media/svg/files/pdf.svg')}}" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-6">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{asset('assets/backend/media/svg/files/tif.svg')}}" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-6">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{asset('assets/backend/media/svg/files/folder-document.svg')}}"
                                                            alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{asset('assets/backend/media/svg/files/css.svg')}}" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-6">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{asset('assets/backend/media/svg/files/ai.svg')}}" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-6">
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{asset('assets/backend/media/svg/files/doc.svg')}}" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-6">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input class="form-control d-flex align-items-center" value=""
                                            ...
                                            data-kt-flags-path="{{asset('assets/backend/media/flags/')}}" />
                                        <!--end::Tagify-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
