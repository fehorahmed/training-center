                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                            action="{{ route('course-category.update',$courseCategory->id) }}" enctype="multipart/form-data">
                            <!--begin::Modal header-->
                            @csrf
                            <!--end::Modal header-->
                            <!--begin::Modal body-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                name="name" id="name" value="{{ old('name',$courseCategory->name) }}">
                                            <!--end::Input-->
                                            @error('name')
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                        ...
                                        <style>
                                            .image-input-placeholder {
                                                background-image: url({{ asset('storage/course_category/'.$courseCategory->image) }});
                                            }
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <label class="form-check form-switch form-check-custom form-check-solid">
                                                    ...
                                                    <input class="form-check-input" name="status" type="checkbox"
                                                        value="1" {{ old('status',$courseCategory->status) == 1 ? 'checked' : '' }}>
                                                    <!--end::Input-->
                                                    <!--begin::Label-->
