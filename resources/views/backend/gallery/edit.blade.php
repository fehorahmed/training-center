        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <!--begin::Filter menu-->
                    <div class="d-flex">
                        <a href="{{ route('admin.gallery.index') }}" class="btn btn-icon btn-sm btn-info flex-shrink-0 ms-4">
                            ...
                            <div class="row mb-6">
                                <div class="col-md-6">
                                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                            value="{{ old('title',$gallery->title) }}" placeholder="Enter title" name="title">
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                            <span class="required">Image Serial</span>
                                        </label>
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid"
                                            value="{{ old('serial',$gallery->serial) }}" placeholder="Enter serial"
                                            name="serial">
                                        @error('serial')
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                        ...
                                        <label class="d-block fw-semibold fs-6 mb-5">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                title="E.g. Select an image dimension is ratio=634:686"></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Image input placeholder-->
                                        <style>
                                            .image-input-placeholder {
                                                background-image: url({{ asset('storage/gallery/'.$gallery->image) }});
                                            }
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                            ...
                                            <input class="form-check-input" name="status" type="checkbox"
                                                value="1" {{ old('status',$gallery->status) == 1 ? 'checked' : '' }}>
                                            <!--end::Input-->
                                            <!--begin::Label-->
