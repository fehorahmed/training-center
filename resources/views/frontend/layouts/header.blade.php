                                    ...
                                    <div class="rbt-header-top-news">
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <span class="news-text"><img src="{{asset('assets/frontend/images/icons/hand-emojji.svg')}}"
                                        ...
                                        <li class="has-child-menu">
                                            <a href="#">
                                                <img class="left-image"
                                                    src="{{ asset('assets/frontend/images/icons/en-us.png') }}"
                                                    alt="Language Images">
                                            ...
                                            {{-- <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image"
                                                            src="{{ asset('assets/frontend/images/icons/fr.png') }}"
                                                            alt="Language Images">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image"
                                                            src="{{ asset('assets/frontend/images/icons/de.png') }}"
                                                            alt="Language Images">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="01-main-demo.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h1.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="12-marketplace.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h12.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="04-kindergarten.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h4.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="13-university-classic.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h13.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="14-home-elegant.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h14.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="09-gym-coaching.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h9.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="03-online-school.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h3.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="06-university-status.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h6.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="15-home-technology.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h15.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="07-instructor-portfolio.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h7.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="08-language-academy.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h8.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="11-single-course.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h11.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="10-online-course.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h10.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="05-classic-lms.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h5.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="02-course-school.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h2.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="16-udemy-affiliate.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h16.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="17-online-academy.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h17.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="18-instructors-coaches.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h18.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="19-modern-university.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h19.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="20-multilingual.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h20.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="21-art-design-school.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h21.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="22-wishlist.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h22.jpg') }}')}} "
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="23-coaching.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h23.jpg') }} "
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="24-health-wellness-institute.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h24.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="25-life-coach.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h25.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="26-islamic-center.html"><img
                                                                        src="{{ asset('assets/frontend/images/splash/demo/h26.jpg') }}"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a
                                                ...
                                                <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                                    <div class="mega-category-item">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('assets/frontend/images/course/category-2.png') }}"
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('assets/frontend/images/course/category-1.png') }}"
                                                                        alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('assets/frontend/images/course/category-4.png') }}"
                                                                        alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img
                                                                        src="{{ asset('assets/frontend/images/course/category-9.png') }}"
                                                                        alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                                    <span>Academy</span>
                                                                    <i class="feather-chevron-right"></i>
                                                ...
                                                <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                                    <div class="rbt-ads-wrapper">
                                                        <a class="d-block" href="#"><img
                                                                src="{{ asset('assets/frontend/images/service/mobile-cat.jpg') }}"
                                    ...
                                    <div class="inner">
                                        <div class="rbt-admin-profile">
                                            <div class="admin-thumbnail">
                                                <img src="{{ asset('assets/frontend/images/team/avatar.jpg') }}"
                                                    alt="User Images">
                                            </div>
                    ...
                    <div class="row g-4 pt--30 pb--60">
                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{ asset('assets/frontend/images/course/course-online-01.jpg') }}"
                                            alt="Card image">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{ asset('assets/frontend/images/course/course-online-03.jpg') }}"
                                            alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{ asset('assets/frontend/images/course/course-online-04.jpg') }}"
                                            alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a
                                                            href="13-university-classic.html">University Classic <span
                                                                class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a
                                                            href="06-university-status.html">University Status <span
                                                                class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="16-udemy-affiliate.html">Udemy
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="17-online-academy.html">Online
                                                            Academy <span class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a
                                                            href="18-instructors-coaches.html">Instructor Coaches
                                                            <span class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="19-modern-university.html">Modern
                                                            University <span class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="20-multilingual.html">Multilingual
                                                            <span class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="21-art-design-school.html">Art
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="22-wishlist.html">Wishlist <span
                                                                class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="23-coaching.html">Coaching <span
                                                                class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a
                                                            href="24-health-wellness-institute.html">Health Institute
                                                            <span class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="25-life-coach.html">Life Coach <span
                                                                class="btn-icon"><i
                                                                    class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="26-islamic-center.html">Islamic
            ...
            <nav class="side-nav w-100">
                <ul class="rbt-minicart-wrapper">
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/product/1.jpg') }}"
                                    alt="Product Images">
                            </a>
                        </div>
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/product/7.jpg') }}"
                                    alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/product/3.jpg') }}"
                                    alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/product/4.jpg') }}"
                                    alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
