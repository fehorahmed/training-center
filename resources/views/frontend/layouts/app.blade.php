        ...
        <ul>
            <li>
                <a href="javascript: void(0);" data-theme="light" class="setColor light">
                    <img src="{{asset('assets/frontend/images/about/sun-01.svg')}}" alt="Sun images"><span title="Light Mode"> Light</span>
                </a>
            </li>
            <li>
                <a href="javascript: void(0);" data-theme="dark" class="setColor dark">
                    <img src="{{asset('assets/frontend/images/about/vector.svg')}}" alt="Vector Images"><span title="Dark Mode"> Dark</span>
                </a>
            </li>
        </ul>
    </div>
                                ...
                                <div class="header-info">
                                    <ul class="rbt-dropdown-menu switcher-language">
                                        <li class="has-child-menu">
                                            <a href="#">
                                                <img class="left-image" src="{{asset('assets/frontend/images/icons/en-us.png')}}" alt="Language Images">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{asset('assets/frontend/images/icons/fr.png')}}" alt="Language Images">
                                                        <span class="menu-item">Français</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="{{asset('assets/frontend/images/icons/de.png')}}" alt="Language Images">
                    ...
                    <div class="header-left rbt-header-content">
                        <div class="header-info">
                            <div class="logo logo-dark">
                                <a href="index.html">
                                    <img src="{{asset('assets/frontend/images/logo/logo.png')}}" alt="Education Logo Images">
                                </a>
                            </div>

                            <div class="logo d-none logo-light">
                                <a href="index.html">
                                    <img src="{{asset('assets/frontend/images/dark/logo/logo-light.png')}}" alt="Education Logo Images">
                                </a>
                            </div>
                        </div>
                        <div class="header-info">
                                            ...
                                            <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="01-main-demo.html"><img src="{{asset('assets/frontend/images/splash/demo/h1.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="12-marketplace.html"><img src="{{asset('assets/frontend/images/splash/demo/h12.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="04-kindergarten.html"><img src="{{asset('assets/frontend/images/splash/demo/h4.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="13-university-classic.html"><img src="{{asset('assets/frontend/images/splash/demo/h13.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="14-home-elegant.html"><img src="{{asset('assets/frontend/images/splash/demo/h14.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="09-gym-coaching.html"><img src="{{asset('assets/frontend/images/splash/demo/h9.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="03-online-school.html"><img src="{{asset('assets/frontend/images/splash/demo/h3.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="06-university-status.html"><img src="{{asset('assets/frontend/images/splash/demo/h6.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="15-home-technology.html"><img src="{{asset('assets/frontend/images/splash/demo/h15.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="07-instructor-portfolio.html"><img src="{{asset('assets/frontend/images/splash/demo/h7.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="08-language-academy.html"><img src="{{asset('assets/frontend/images/splash/demo/h8.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="11-single-course.html"><img src="{{asset('assets/frontend/images/splash/demo/h11.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="10-online-course.html"><img src="{{asset('assets/frontend/images/splash/demo/h10.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="05-classic-lms.html"><img src="{{asset('assets/frontend/images/splash/demo/h5.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="02-course-school.html"><img src="{{asset('assets/frontend/images/splash/demo/h2.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="16-udemy-affiliate.html"><img src="{{asset('assets/frontend/images/splash/demo/h16.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="17-online-academy.html"><img src="{{asset('assets/frontend/images/splash/demo/h17.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="18-instructors-coaches.html"><img src="{{asset('assets/frontend/images/splash/demo/h18.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="19-modern-university.html"><img src="{{asset('assets/frontend/images/splash/demo/h19.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="20-multilingual.html"><img src="{{asset('assets/frontend/images/splash/demo/h20.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="21-art-design-school.html"><img src="{{asset('assets/frontend/images/splash/demo/h21.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="22-wishlist.html"><img src="{{asset('assets/frontend/images/splash/demo/h22.jpg')}}')}} " alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="23-coaching.html"><img src="{{asset('assets/frontend/images/splash/demo/h23.jpg')}} " alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="24-health-wellness-institute.html"><img src="{{asset('assets/frontend/images/splash/demo/h24.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="25-life-coach.html"><img src="{{asset('assets/frontend/images/splash/demo/h25.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="26-islamic-center.html"><img src="{{asset('assets/frontend/images/splash/demo/h26.jpg')}}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                                    <div class="mega-category-item">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="{{asset('assets/frontend/images/course/category-2.png')}}" alt="Course images"></div>
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="{{asset('assets/frontend/images/course/category-1.png')}}" alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="{{asset('assets/frontend/images/course/category-4.png')}}" alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="{{asset('assets/frontend/images/course/category-9.png')}}" alt="Course images"></div>
                                                                <a href="course-filter-one-toggle.html">
                                                                    <span>Academy</span>
                                                                    <i class="feather-chevron-right"></i>
                                                                </a>
                                            ...
                                            <div class="row row--15">
                                                ...
                                                <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                                    <div class="rbt-ads-wrapper">
                                                        <a class="d-block" href="#"><img src="{{asset('assets/frontend/images/service/mobile-cat.jpg')}}" alt="Education Images"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="inner">
                                        <div class="rbt-admin-profile">
                                            <div class="admin-thumbnail">
                                                <img src="{{asset('assets/frontend/images/team/avatar.jpg')}}" alt="User Images">
                                            </div>
                    ...
                    <div class="row g-4 pt--30 pb--60">
                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{asset('assets/frontend/images/course/course-online-01.jpg')}}" alt="Card image">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{asset('assets/frontend/images/course/course-online-02.jpg')}}" alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{asset('assets/frontend/images/course/course-online-03.jpg')}}" alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="{{asset('assets/frontend/images/course/course-online-04.jpg')}}" alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                                    <h5 class="rbt-card-title"><a href="course-details.html">Web Design</a>
            ...
            <nav class="side-nav w-100">
                <ul class="rbt-minicart-wrapper">
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{asset('assets/frontend/images/product/1.jpg')}}" alt="Product Images">
                            </a>
                        </div>
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{asset('assets/frontend/images/product/7.jpg')}}" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{asset('assets/frontend/images/product/3.jpg')}}" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{asset('assets/frontend/images/product/4.jpg')}}" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                        ...
                        <div class="content">
                            ...
                            <div class="shape-wrapper" id="scene">
                                ...
                                <div class="hero-bg-shape-1 layer" data-depth="0.4">
                                    <img src="{{asset('assets/frontend/images/shape/shape-01.png')}}" alt="Hero Image Background Shape">
                                </div>
                                <div class="hero-bg-shape-2 layer" data-depth="0.4">
                                    <img src="{{asset('assets/frontend/images/shape/shape-02.png')}}" alt="Hero Image Background Shape">
                                </div>
                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="course-details.html">
                                                    <img src="{{asset('assets/frontend/images/course/classic-lms-01.jpg')}}" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>-40%</span>
                                                        <span>Off</span>
                                                    </div>
                ...
                <div class="row g-5 mt--20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/web-design.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/design.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/personal.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/server.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/pantone.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/paint-palette.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/smartphone.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{asset('assets/frontend/images/category/infographic.png')}}" alt="Icons Images">
                                </div>
                                <div class="content">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <div class="rbt-author-meta mb--20">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="{{asset('assets/frontend/images/client/avater-01.png')}}" alt="Sophia Jaymes">
                                        </a>
                                    </div>
                        ...
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <div class="rbt-author-meta mb--20">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="{{asset('assets/frontend/images/client/avatar-03.png')}}" alt="Sophia Jaymes">
                                        </a>
                                    </div>
                                    <div class="rbt-author-info">
                    ...
                    <div class="col-lg-6">
                        <div class="thumbnail-wrapper">
                            <div class="thumbnail image-1">
                                <img data-parallax='{"x": 0, "y": -20}' src="{{asset('assets/frontend/images/about/about-01.png')}}" alt="Education Images">
                            </div>
                            <div class="thumbnail image-2 d-none d-xl-block">
                                <img data-parallax='{"x": 0, "y": 60}' src="{{asset('assets/frontend/images/about/about-02.png')}}" alt="Education Images">
                            </div>
                            <div class="thumbnail image-3 d-none d-md-block">
                                <img data-parallax='{"x": 0, "y": 80}' src="{{asset('assets/frontend/images/about/about-03.png')}}" alt="Education Images">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-12 col-xl-7">
                                    <div class="video-popup-wrapper mt_lg--10 mt_md--20 mt_sm--20">
                                        <img class="w-100 rbt-radius" src="{{asset('assets/frontend/images/others/video-01.jpg')}}" alt="Video Images">
                            ...
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-01.png')}}" alt="Clint Images">
                                        </div>
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-02.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-03.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-04.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-05.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-07.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-08.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <div class="clint-info-wrapper">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/testimonial/client-06.png')}}" alt="Clint Images">
                                        </div>
                                        <div class="client-info">
                                        ...
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="{{asset('assets/frontend/images/event/grid-type-02.jpg')}}" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Mar</span>
                                                        <span>2024</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="{{asset('assets/frontend/images/event/grid-type-04.jpg')}}" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Jan</span>
                                                        <span>2024</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="{{asset('assets/frontend/images/event/grid-type-05.jpg')}}" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Mar</span>
                                                        <span>2024</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="{{asset('assets/frontend/images/event/grid-type-01.jpg')}}" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Jan</span>
                                                        <span>2024</span>
                                                    </div>
                        ...
                        <div class="rbt-team-tab-content tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="team-tab1" role="tabpanel" aria-labelledby="team-tab1-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/team/team-01.jpg')}}" alt="Testimonial Images">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="team-tab2" role="tabpanel" aria-labelledby="team-tab2-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/team/team-02.jpg')}}" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab3" role="tabpanel" aria-labelledby="team-tab3-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/team/team-03.jpg')}}" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab4" role="tabpanel" aria-labelledby="team-tab4-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/team/team-04.jpg')}}" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab5" role="tabpanel" aria-labelledby="team-tab5-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/team/team-05.jpg')}}" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab6" role="tabpanel" aria-labelledby="team-tab6-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('assets/frontend/images/team/team-06.jpg')}}" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                ...
                <div class="row row--15">
                        ...
                        <div class="rbt-card variation-02 height-330 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('assets/frontend/images/blog/blog-card-01.jpg')}}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('assets/frontend/images/blog/blog-card-02.jpg')}}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('assets/frontend/images/blog/blog-card-03.jpg')}}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('assets/frontend/images/blog/blog-card-04.jpg')}}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="row row--15 mt_dec--30">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30">
                            <div class="footer-widget">
                                ...
                                <div class="logo d-none logo-light">
                                    <a href="index.html">
                                        <img src="{{asset('assets/frontend/images/dark/logo/logo-light.png')}}" alt="Edu-cause">
                                    </a>
                                </div>
