                ...
                <div class="row g-5 mt--20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/web-design.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/design.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/personal.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/server.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/pantone.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/paint-palette.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/smartphone.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/category/infographic.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets/frontend/images/course/course-02.jpg') }}"
                                        alt="Card image">
                                    <div class="rbt-badge-3 bg-white">
                                        <span>-40%</span>
                                        <span>Off</span>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets/frontend/images/course/course-03.jpg') }}"
                                        alt="Card image">
                                    <div class="rbt-badge-3 bg-white">
                                        <span>-40%</span>
                                        <span>Off</span>
                        ...
                        <div class="thumbnail-wrapper">
                            <div class="thumbnail image-1">
                                <img data-parallax='{"x": 0, "y": -20}'
                                    src="{{ asset('assets/frontend/images/about/about-01.png') }}"
                                    alt="Education Images">
                            </div>
                            <div class="thumbnail image-2 d-none d-xl-block">
                                <img data-parallax='{"x": 0, "y": 60}'
                                    src="{{ asset('assets/frontend/images/about/about-02.png') }}"
                                    alt="Education Images">
                            </div>
                            <div class="thumbnail image-3 d-none d-md-block">
                                <img data-parallax='{"x": 0, "y": 80}'
                                    src="{{ asset('assets/frontend/images/about/about-03.png') }}"
                                    alt="Education Images">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5 hanger-line">
                        ...
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="{{ asset('assets/frontend/images/icons/counter-01.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30 mt_mobile--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="{{ asset('assets/frontend/images/icons/counter-02.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--60 mt_sm--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="{{ asset('assets/frontend/images/icons/counter-03.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30 mt_mobile--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="{{ asset('assets/frontend/images/icons/counter-04.png') }}"
                                        alt="Icons Images">
                                </div>
                                <div class="content">
                ...
                <div class="scroll-animation scroll-right-left">
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="icons">
                                    <img src="{{ asset('assets/frontend/images/icons/facebook.png') }}"
                                        alt="Clint Images">
                                </div>
